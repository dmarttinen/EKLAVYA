...
# dirpath = '/home/bbaker/CSCI5271/Project/EKLAVYA/new_pickles/'
...
#    filepath = dirpath + "/" + filename
    ...
    for line in f.readlines():
        ...
        if flag == 'function' and high_pattern.search(line) and low:  # find the upper bound of the addresses
            ...
            bounds = (low, high)
        if flag == 'function' and name_pattern.search(line):  # find the function name
